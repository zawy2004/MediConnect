...
public class DashboardModel : PageModel
{
    ...
    public DashboardModel(IPatientPortalService patientPortalService, IAppointmentService appointmentService)
    {
    ...
    {
        Data = await _patientPortalService.GetDashboardAsync(GetUserId());
    }
